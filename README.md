...
新增票据必填、政策限额、重复票据指纹、业务用途和逐行核减能力，汇总申报金额、批准金额、核减金额及人工复核结论。接口为 `POST /api/advanced/expense/policy-check`。
...
新增企业卡账单导入、持卡人映射、票据、商户/日期/金额匹配、重复风险、政策例外、税务、成本中心、个人消费归还、过账平衡、财务审批和职责分离门禁。详见[企业卡对账结算说明](docs/ENTERPRISE_CORPORATE_CARD_RECONCILIATION.md)。
